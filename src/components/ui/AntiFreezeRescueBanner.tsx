      ...
      <div className="flex items-start space-x-3.5">
        ...
        <div className="flex-1 min-w-0 space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <h3 className="text-sm font-bold text-amber-400 flex items-center gap-1.5">
                <span>Détecteur Anti-Freeze : Gel de {lagDurationMs}ms intercepté !</span>
              </h3>
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Le thread JavaScript principal a subi un blocage temporaire de <strong className="text-amber-300 font-mono">{lagDurationMs}ms</strong> (seuil de sécurité : {thresholdMs}ms). Le système a neutralisé le crash sans perte de travail :
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] pt-1">
            <div className="flex items-center space-x-1.5 bg-[#1C2029] px-2.5 py-1.5 rounded-lg border border-[#2D3342] text-emerald-300">
              ...
              <span>Garbage Collection VRAM exécutée</span>
            </div>
            ...
            <div className="flex items-center space-x-1.5 bg-[#1C2029] px-2.5 py-1.5 rounded-lg border border-[#2D3342] text-amber-300">
              ...
              <span>Ombres dynamiques figées (Éco)</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-[#252B38] mt-2">
            ...
            >
              ...
              <span>Gérer les options d'optimisation</span>
            </button>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                title="Rétablir les ombres dynamiques et le sous-échantillonnage"
              >
                <RotateCcw className="w-3.5 h-3.5 text-amber-400" />
                <span>Rétablir les graphismes</span>
              </button>
